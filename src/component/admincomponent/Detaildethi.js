...
class Detaildethi extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ten: '',
    ...
    render() {
        ...
        return (
            <div className="container">
                ...
                <br />
                <div>
                    <a style={{ float: 'left' }} onClick={() => this.tooglePage(<Quanlydethi />)}>
...
export default connect(mapStateToProps, mapDispatchToProps)(Detaildethi);